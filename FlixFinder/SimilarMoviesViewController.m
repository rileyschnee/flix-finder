...
@interface SimilarMoviesViewController () <UICollectionViewDataSource, UICollectionViewDelegate>
...
- (void)fetchMovies {
    ...
    NSString *urlString = [NSString stringWithFormat:@"https://api.themoviedb.org/3/movie/%@/similar?api_key=68e66492655ae4158df702fc167d958f", self.movie[@"id"]];
